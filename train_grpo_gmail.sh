...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES WANDB_DISABLE_ARTIFACTS=True WANDB_DISABLE_CODE=True WANDB_CONSOLE=off WANDB_START_METHOD='thread' \
torchrun --nproc_per_node=$n_gpu verl/trainer/main_ppo.py \
